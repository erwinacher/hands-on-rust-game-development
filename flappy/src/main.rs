...
impl Player {
    ...
    fn flap(&mut self) {
        self.velocity = -2.0; // 0 is the top of the screen -2 means moving the dragon upwards
    }
}

struct State {
    player: Player, 
    frame_time: f32, // tracks time accumulated btween frames, controls the game speed
    mode: GameMode,
}
impl State {
    fn new() -> Self {
        State {
            ...
            frame_time: 0.0, // start with zero, not playing 
            mode: GameMode::Menu,
        }
    }
